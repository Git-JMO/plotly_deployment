...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sampleFirst = sampleResult[0];
    // 6. Create variables that hold the otu_ids, otu_labels, and sample_values.
    var sample_otu_ids = sampleFirst.otu_ids;
    var sample_otu_labels = sampleFirst.otu_labels;
    ...
    var firstSamp = sampleMetadata.filter(sampleData => sampleData.id == sample);
    // 2. Create a variable that holds the first sample in the metadata array.
    var resultSample = firstSamp[0];
    // 3. Create a variable that holds the washing frequency.
    var washFreq = resultSample.wfreq;
